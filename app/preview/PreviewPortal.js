...
const exportCSV = () => {
  ...
  <div>
    <span className="preview-eyebrow">
      StudentPay Provider Portal
    </span>

    <h1>
      Welcome {userIsLoaded ? firstName : ''}
...
>
  ...
  <span className="export-card-content">
    ...
    <small>Download records</small>
          ...
          <section className="preview-arrears-grid">
            <article>
              <span>Current</span>
          ...
          <section className="preview-panel">
            <div className="preview-panel-header">
              <div>
                ...
                <h2>Payment Plans</h2>
                <p>
                  Search and review current provider payment plans.
                </p>
              </div>
                ...
                <tbody>
                  {filteredPlans.map((plan) => (
                    <tr key={plan.id || plan.plan}>
                      ...
                      <td>
                        <span className="authorisation-pill">
                          {plan.authorisationStatus || '—'}
                        </span>
                      </td>
          ...
          >
            ...
            <div className="detail-banner">
              <div>
                ...
                <strong>
                  {formatCurrency(selectedPlan.remaining)}
                </strong>
              </div>
            ...
            <div className="detail-grid">
              <article className="detail-section">
                ...
                <div className="detail-row">
                  ...
                  <strong>
                    {formatDate(selectedPlan.agreementDate)}
                  </strong>
                </div>
                ...
                <div className="detail-row">
                  ...
                  <strong>
                    {selectedPlan.authorisationStatus || '—'}
                  </strong>
                </div>
              </article>
